...
#
#
#FROM busybox AS export-apk
#
## Создаём папку для volume
#RUN mkdir -p /output
#
## Копируем APK из production stage
#COPY --from=production /app/build/app/outputs/flutter-apk/app-release.apk /output/